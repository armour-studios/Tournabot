...
`];
  const helpSelectionEmbed = new EmbedBuilder()
    ...
    .setFooter({ text: `Page ${index + 1} of 2`, iconURL: 'https://cdn.discordapp.com/attachments/719461475848028201/777094320531439636/image.png' });
...
${descriptions[index]}`)
    ...
    .setFooter({ text: `Command ${index + 1} of 3`, iconURL: 'https://cdn.discordapp.com/attachments/719461475848028201/777094320531439636/image.png' });
...
`)
    ...
    .setFooter({ text: `Command 1 of 1`, iconURL: 'https://cdn.discordapp.com/attachments/719461475848028201/777094320531439636/image.png' });
  return accountsEmbed;
}
...
${descriptions[index]}`)
    .setImage(examples[index])
    .setFooter({ text: `Command ${index + 1} of 4`, iconURL: 'https://cdn.discordapp.com/attachments/719461475848028201/777094320531439636/image.png' });
...
${descriptions[index]}`)
    .setImage(examples[index])
    .setFooter({ text: `Command ${index + 1} of 2`, iconURL: 'https://cdn.discordapp.com/attachments/719461475848028201/777094320531439636/image.png' });
...
${descriptions[index]}`)
    .setImage(examples[index])
    .setFooter({ text: `Command ${index + 1} of 5`, iconURL: 'https://cdn.discordapp.com/attachments/719461475848028201/777094320531439636/image.png' });
